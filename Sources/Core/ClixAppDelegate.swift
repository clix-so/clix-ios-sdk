...
open class ClixAppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, MessagingDelegate {
    ...
    open func userNotificationCenter(
        ...
        } else if let fcmOptions = userInfo["fcm_options"] as? [String: Any], let fcmImage = fcmOptions["image_url"] as? String {
            imageURLString = fcmImage
        } else if let fcmOptions = userInfo["fcm_options"] as? NSDictionary, let fcmImage = fcmOptions["image_url"] as? String {
            imageURLString = fcmImage
        }
