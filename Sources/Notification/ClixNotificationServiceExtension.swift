...
open class ClixNotificationServiceExtension: UNNotificationServiceExtension {
  ...
  private func getAppGroupIdFromProjectId() -> String {
    ...
    guard !projectId.isEmpty else {
      ...
      NSLog(
        "[ClixNotificationServiceExtension] WARNING: Project ID not found in UserDefaults, using fallback app group ID"
      )
  ...
  open override func didReceive(
    ...
    if projectId == nil {
      NSLog(
        "[ClixNotificationServiceExtension] WARNING: Project ID not registered. Call register(projectId:) before using this extension."
      )
